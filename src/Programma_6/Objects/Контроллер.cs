...
namespace IIS.Programma_6
{
    ...
    public class Контроллер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma_6.Сенсоры fСенсоры;
        
        private IIS.Programma_6.Серверная fСерверная;
        ...
        [PropertyStorage(new string[] {
                "Сенсоры"})]
        [NotNull()]
        public virtual IIS.Programma_6.Сенсоры Сенсоры
        {
            get
            {
                ...
                IIS.Programma_6.Сенсоры result = this.fСенсоры;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Programma_6.Серверная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Серверная"})]
        public virtual IIS.Programma_6.Серверная Серверная
        {
            get
            {
                ...
                IIS.Programma_6.Серверная result = this.fСерверная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтроллерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтроллерE", typeof(IIS.Programma_6.Контроллер));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтроллер : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Programma_6.DetailArrayOfКонтроллер members)

        // *** End programmer edit section *** (IIS.Programma_6.DetailArrayOfКонтроллер members)
        ...
        /// </summary>
        public DetailArrayOfКонтроллер(IIS.Programma_6.Серверная fСерверная) : 
                base(typeof(Контроллер), ((ICSSoft.STORMNET.DataObject)(fСерверная)))
        {
        }
        
        public IIS.Programma_6.Контроллер this[int index]
        {
            get
            {
                return ((IIS.Programma_6.Контроллер)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Programma_6.Контроллер dataobject)
        {
